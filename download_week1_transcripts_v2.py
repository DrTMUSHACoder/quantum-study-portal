...
class BorderedPDF(FPDF):
    def __init__(self, video_number, lecture_title):
        super().__init__()
...
for idx, video_data in enumerate(WEEK1_VIDEOS, 1):
    ...
    # Save PDF with new naming format: W1V1.pdf, W1V2.pdf, etc.
    output_path = f"resources/Transcript/Week1/W1V{idx}.pdf"
